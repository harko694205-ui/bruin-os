  ...
  const timeFields = (
    <div className="field-row">
      <div className="field">
        ...
        <input type="time" className="input" value={form.startTime || ''} onChange={(e) => { setForm({ ...form, startTime: e.target.value }); setError(''); }} />
      </div>
      <div className="field">
        <label>End time (optional)</label>
        <input type="time" className="input" value={form.endTime || ''} onChange={(e) => { setForm({ ...form, endTime: e.target.value }); setError(''); }} />
      </div>
    </div>
  );
